...
struct DesktopStrings {
    ...
    private static func english(_ key: DesktopTextKey) -> String {
        ...
        case .tasksSubtitle: return "Workflow definitions stay pinned to one workspace and can be reused from the terminal surface."
        ...
        case .desktopInstallerSubtitle: return "Use the shell script below to build a signed local bundle, copy it into Applications, and refresh the Downloads DMG."
    ...
    private static func korean(_ key: DesktopTextKey) -> String {
        ...
        case .desktopInstallerSubtitle: return "아래 스크립트로 서명된 로컬 번들을 만들고 Applications에 복사한 뒤 Downloads DMG도 갱신할 수 있습니다."
