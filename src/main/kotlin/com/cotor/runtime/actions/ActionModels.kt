...
enum class ActionKind(val wireValue: String) {
    ...
    BROWSER_RECORD("browser.record"),
    BROWSER_EXTERNAL_DOMAIN("browser.external-domain"),
    BROWSER_LOGIN_FLOW("browser.login-flow"),
    VIDEO_SCRIPT_WRITE("video.script-write"),
    VIDEO_RENDER_LOCAL("video.render-local"),
    VIDEO_GENERATE_REMOTE("video.generate-remote"),
